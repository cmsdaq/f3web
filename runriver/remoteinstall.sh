...
echo -e '\nUPLOADING\n' #set VERSION!!!!!!!!!!!!!!!!!!!
sshpass -p 'ominozzo2' parallel-scp -h /home/salvo/Scrivania/PH-CMD/cdaCloud/cuhosts -l bufu -A /home/salvo/Scrivania/PH-CMD/f3web/runriver/target/releases/river-runriver-1.3.0-plugin.zip  /home/bufu
...
echo -e '\nINSTALL NEW PLUGIN\n' #set VERSION!!!!!!!!!!!!!!!!!!!
sshpass -p 'ominozzo2' parallel-ssh -h /home/salvo/Scrivania/PH-CMD/cdaCloud/cuhosts -l bufu -AIi "sudo -S /usr/share/elasticsearch/bin/plugin -url file:/home/bufu/river-runriver-1.3.0-plugin.zip -i river-runriver" < /home/salvo/Scrivania/PH-CMD/cdaCloud/pass
