...
$jsonQuery["query"]["filtered"]["filter"]["and"]["filters"][1]["range"]["ls"]["from"]= $from;
$jsonQuery["query"]["filtered"]["filter"]["and"]["filters"][1]["range"]["ls"]["to"]= $to;
$jsonQuery["aggs"]["stream"]["aggs"]["ls"]["histogram"]["extended_bounds"]["min"]= $from;
$jsonQuery["aggs"]["stream"]["aggs"]["ls"]["histogram"]["extended_bounds"]["max"]= $to;
$jsonQuery["aggs"]["stream"]["aggs"]["ls"]["histogram"]["interval"]= intval($interval);
